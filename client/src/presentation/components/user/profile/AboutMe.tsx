const AboutMe=()=>{
    return( <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              and cloud technologies. Looking for opportunities to work on
              challenging projects that make a real impact. Strong
              problem-solving skills and a team player who thrives in
